...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .hero-section{padding:2rem 1rem 1.5rem;border-radius:16px;}
        .hero-name{font-size:1.8rem!important;}
        .hero-title{font-size:.9rem!important;}
        .hero-tagline{font-size:.78rem!important;}
        .hero-badges{gap:4px;}
        .h-badge{font-size:.6rem!important;padding:3px 8px!important;}
        .contact-bar{flex-direction:column;gap:6px!important;padding:12px!important;}
        .contact-bar a{font-size:.75rem!important;padding:6px 12px!important;}
        .metric-card{padding:12px 8px!important;}
        .metric-card .m-value{font-size:1.4rem!important;}
        .metric-card .m-label{font-size:.65rem!important;}
        ...
        .score-box{padding:16px!important;}
        .score-num{font-size:2.5rem!important;}
        .cs-card{padding:16px!important;}
        .reco-card{padding:16px!important;}
        .profil-card{padding:16px!important;}
        .profil-card p{font-size:.85rem!important;}
        .pt-fort,.pt-att{font-size:.8rem!important;padding:8px 10px!important;}
    }
    @media (max-width: 480px) {
        .hero-name{font-size:1.5rem!important;}
        .hero-title{font-size:.8rem!important;}
        .hero-badges{gap:3px;}
        .h-badge{font-size:.55rem!important;padding:2px 6px!important;}
        .stTabs [data-baseweb="tab"]{font-size:.6rem!important;padding:8px 10px!important;}
