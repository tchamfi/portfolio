...
<style>
    ...
    /* TABS */
    .stTabs [data-baseweb="tab-list"]{background:linear-gradient(135deg,#0f172a,#1e293b);border-radius:20px;padding:12px 14px;gap:8px;border:none;box-shadow:0 10px 40px rgba(15,23,42,.3);justify-content:center;}
    .stTabs [data-baseweb="tab"]{font-weight:800;font-size:1.05rem;color:#94a3b8!important;border-radius:14px;padding:16px 32px;background:transparent;border:none;transition:all .25s ease;letter-spacing:.01em;}
    .stTabs [data-baseweb="tab"]:hover{color:#ffffff!important;background:rgba(255,255,255,.08);}
    .stTabs [aria-selected="true"]{background:linear-gradient(135deg,#6366f1,#8b5cf6)!important;color:#ffffff!important;border:none!important;box-shadow:0 4px 20px rgba(99,102,241,.5);-webkit-text-fill-color:#ffffff!important;}
